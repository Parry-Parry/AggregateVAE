...
def main():
    os.system('python AggregateVAE/scripts/training/recons_grid_eval_tabular.py --script AggregateVAE/scripts/training/recons/tabular.py --dataset bankbalance --datastore ds/bank/balance --outstore train/bank/aggr --batch_size 8 --gpus 1')
    ...
    os.system('python AggregateVAE/scripts/training/std_grid_eval.py --script AggregateVAE/scripts/training/std/tabular.py --dataset bankjob --datastore ds/bankjob --outstore train/bank/aggr --batch_size 8 --gpus 1')
    ...
    os.system('python AggregateVAE/scripts/training/std_grid_eval.py --script AggregateVAE/scripts/training/std/tabular.py --dataset bank --datastore ds/bank/std --outstore train/bank/baseline --batch_size 128 --gpus 1')
