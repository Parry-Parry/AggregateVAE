...
def main():
    ...
    os.system('python AggregateVAE/scripts/training/std_grid_eval.py --script AggregateVAE/scripts/training/std/tabular.py --dataset bank --datastore ds/bank/std --outstore train/bank/baseline --batch_size 8 --gpus 1 --eps 0.0')
