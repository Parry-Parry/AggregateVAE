...
from aggrVAE.image_old.classifier.seq import classifier_head, Classifier
from aggrVAE.image_old.classifier.ensemble import EnsembleClassifier
...
def main(args):
    ...
    root_path = os.path.join(args.log_dir, f"{args.ds}.{args.K}.{args.heads}.{args.epsilon}")
